...
- This key is defined in the [JSON Schema](https://github.com/chargebee/cb-partner-spi/blob/main/spec/capabilities/einvoicing-provider.schema.json), which must be completed and submitted by the partner during the app registration process in Chargebee’s Marketplace.
