...
To obtain your OAuth 2.0 credentials:

1. Follow the [App onboarding process](../../../app-onboarding/guide)
2. Our team will review your application and reach out to provide your client credentials
...
```bash
curl -X POST 'https://qpp.chargebee.com/oauth/token' \
