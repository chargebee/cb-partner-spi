...
## SPI Adapter app -> Chargebee app
 ...
 For Partners, some endpoints are exposed by Chargebee such as [/webhooks/einvoicing-spi/{partner-id}/document_status](../endpoints/v1/webhooks/receive-document-status-updates.mdx) are designed to be called by the partner-hosted adapter. These endpoints require authorization using **OAuth 2.0**.
