...
- This key is defined in the [JSON Schema](https://github.com/chargebee/cb-partner-spi/tree/main/spec/capabilities), which must be completed and submitted by the partner during the app registration process in Chargebee’s Marketplace.
