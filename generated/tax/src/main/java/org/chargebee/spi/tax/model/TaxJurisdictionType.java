 ...
 */
@JsonAdapter(TaxJurisdictionType.Adapter.class)
public enum TaxJurisdictionType {
  ...
  public static class Adapter extends TypeAdapter<TaxJurisdictionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TaxJurisdictionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TaxJurisdictionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TaxJurisdictionType.fromValue(value);
    }
  }
}
