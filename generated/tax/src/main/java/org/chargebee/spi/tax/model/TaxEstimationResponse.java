...
public class TaxEstimationResponse {
  ...
  **/
  ...
  public TaxEstimationResponse lineItems(List<InvoiceLineItem> lineItems) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TaxEstimationResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TaxEstimationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxEstimationResponse is not found in the empty JSON string", TaxEstimationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TaxEstimationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaxEstimationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TaxEstimationResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxEstimationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxEstimationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxEstimationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxEstimationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxEstimationResponse>() {
           @Override
           public void write(JsonWriter out, TaxEstimationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaxEstimationResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TaxEstimationResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxEstimationResponse
  * @throws IOException if the JSON string is invalid with respect to TaxEstimationResponse
  */
  public static TaxEstimationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxEstimationResponse.class);
  }

 /**
  * Convert an instance of TaxEstimationResponse to an JSON string
  *
  * @return JSON string
  */
