...
public class CheckAddressTaxabilityResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CheckAddressTaxabilityResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckAddressTaxabilityResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckAddressTaxabilityResponse is not found in the empty JSON string", CheckAddressTaxabilityResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckAddressTaxabilityResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckAddressTaxabilityResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CheckAddressTaxabilityResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckAddressTaxabilityResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckAddressTaxabilityResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckAddressTaxabilityResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckAddressTaxabilityResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckAddressTaxabilityResponse>() {
           @Override
           public void write(JsonWriter out, CheckAddressTaxabilityResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckAddressTaxabilityResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CheckAddressTaxabilityResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CheckAddressTaxabilityResponse
  * @throws IOException if the JSON string is invalid with respect to CheckAddressTaxabilityResponse
  */
  public static CheckAddressTaxabilityResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckAddressTaxabilityResponse.class);
  }

 /**
  * Convert an instance of CheckAddressTaxabilityResponse to an JSON string
  *
  * @return JSON string
  */
