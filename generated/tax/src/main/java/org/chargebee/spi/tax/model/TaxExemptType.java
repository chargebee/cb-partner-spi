 ...
 */
@JsonAdapter(TaxExemptType.Adapter.class)
public enum TaxExemptType {
  ...
  public static class Adapter extends TypeAdapter<TaxExemptType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TaxExemptType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TaxExemptType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TaxExemptType.fromValue(value);
    }
  }
}
