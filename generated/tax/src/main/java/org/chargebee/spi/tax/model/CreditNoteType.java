 ...
 */
@JsonAdapter(CreditNoteType.Adapter.class)
public enum CreditNoteType {
  ...
  public static class Adapter extends TypeAdapter<CreditNoteType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreditNoteType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreditNoteType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreditNoteType.fromValue(value);
    }
  }
}
