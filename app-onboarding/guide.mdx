...
4. **Test the Integration**: Validate and test your integration using the provided [Postman collection](https://www.postman.com/chargebee/chargebee-partners/overview). 
...
1.  **Compliance with PII Standards**
    ...
    -   Refer to Chargebee's [Security and Compliance Guidelines](https://www.chargebee.com/security-compliance/) to meet data privacy and security requirements.
