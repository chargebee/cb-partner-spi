...
1. **Fill Configuration & Capability**
  - Fill in the configuration and capabilities of your adapter by referring to the [JSON Schema](https://github.com/chargebee/cb-partner-spi/tree/main/spec/capabilities) provided by Chargebee.
